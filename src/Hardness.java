public class Hardness {
    ...
    public static void main (String args[]){
        ...
        float hardRES = (float)(((2*volimeHARD1*concentration*1000)/volume)+((2*volimeHARD2*concentration*1000)/volume))/2;
        float calciumRES =(float)(((40.08*concentration*volumecalcium1*1000)/volume)+((40.08*concentration*volumecalcium2*1000)/volume))/2;
        float magnesiumRES = (float)((((volimeHARD1-volumecalcium1)*concentration*24.32*1000)/volume)+(((volimeHARD2-volumecalcium2)*concentration*24.32*1000)/volume))/2;
        ...
        } else pogreshnost = (float)(calciumRES *0.11);
